...
const MainMap = ({ setPage }) => {
  ...
  var moveMarkerImage = new kakao.maps.MarkerImage(
    moveImageSrc,
    moveImageSize,
    moveImageOption
  );
  ...
  const handleClickCategory = (e) => {
    ...
    place.categorySearch(e.currentTarget.id, placesSearchCB, {
      useMapBounds: true,
    });
  };
  ...
  return (
    <>
          ...
          >
            ...
            <li onClick={handleClickCategory} id="CE7" className="category-box">
              <img
                ...
                alt="coffeeImage"
                width="30"
                src="https://cdn-icons-png.flaticon.com/512/924/924463.png"
              />
              카페
            </li>
            <li onClick={handleClickCategory} id="AT4" className="category-box">
              <img
                ...
                alt="tourImage"
                width="30"
                src="https://cdn-icons-png.flaticon.com/512/9638/9638606.png"
              />
              볼거리
            </li>
            <li onClick={handleClickCategory} id="CT1" className="category-box">
              <img
                ...
                alt="enjoyImage"
                width="30"
                src="https://cdn-icons-png.flaticon.com/512/1518/1518943.png"
              />
              즐길거리
            </li>
          </ul>
        ...
        <div id="menu_wrap">
          <div>
            <input
              ...
              value={keyword}
            />
            <button onClick={handleGetPlaces} style={{ width: "100%" }}>
              검색
            </button>
          </div>
      ...
      <button onClick={handleWriteModal} className="write-button">
        <img
          alt="writeImage"
          width="30px"
